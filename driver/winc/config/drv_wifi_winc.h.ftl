...
<#if WIFI_EXTERNAL_INTERRUPT_USE == "EIC">
#define WDRV_WINC_EIC_SOURCE        EIC_PIN_${WIFI_DRIVER_EIC_SRC_SELECT}
<#elseif WIFI_EXTERNAL_INTERRUPT_USE == "External_Interrupt">
...
<#if WIFI_DRIVER_MODE_CHOICE == "Ethernet Mode">
...
<#if WIFI_DRIVER_MODE_CHOICE == "Socket Mode">
