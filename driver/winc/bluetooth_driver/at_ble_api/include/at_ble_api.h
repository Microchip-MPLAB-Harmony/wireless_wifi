/*******************************************************************************
  ...
  Description:
    This module contains the public API and the necessary enumerations and
    structures that are required for WINC3400 BLE application developers
...
typedef enum{
    ...
    /** Health Thermometer Inform APP of database creation status. \n
     * Refer to @ref at_ble_htpt_create_db_cfm_t
     */
    AT_BLE_HTPT_CREATE_DB_CFM,
    /** Health Thermometer Error indication to APP. \n
     * Refer to @ref at_ble_prf_server_error_ind_t
     */
    AT_BLE_HTPT_ERROR_IND,
    /** Health Thermometer Automatically sent to the APP after a disconnection with the peer device to confirm disabled profile. \n
     * Refer to @ref at_ble_htpt_disable_ind_t
     */
    AT_BLE_HTPT_DISABLE_IND,
    /** Health Thermometer Temperature value confirm to APP. \n
     * Refer to @ref at_ble_htpt_temp_send_cfm_t
     */
    AT_BLE_HTPT_TEMP_SEND_CFM,
    /** Health Thermometer Inform APP of new measurement interval value. \n
     * Refer to @ref at_ble_htpt_meas_intv_chg_ind_t
     */
    AT_BLE_HTPT_MEAS_INTV_CHG_IND,
    /** Health Thermometer Inform APP of new configuration value. \n
...
/**@brief Health Thermometer Database Configuration Flags
*/
typedef enum
{
...
/**@brief Health Thermometer Service Security Level
*/
...
/**@brief Health Thermometer Attribute Table Indexes
*/
typedef enum
{
    HTPT_TEMP_MEAS_CHAR,
...
/**@brief Health Thermometer Temperature Measurement Flags field bit values
*/
typedef enum
{
...
/**@brief Health Thermometer Temperature Type Description
*/
typedef enum
{
    /// Armpit
...
/**@brief Health Thermometer Connection Type
*/
typedef enum
{
    HTPT_CONFIG_CONN= 0,
...
/**@brief Health Thermometer Enable/Disable Notification/Indication
*/
typedef enum
{
...
/**@brief Health Thermometer Enable Notification/Indication for HTPT characteristics
*/
typedef enum
{
