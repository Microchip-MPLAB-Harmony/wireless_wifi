...
typedef struct
{
    ...
    //         In these cases the PA gain is reduced to the minimum allowed i.e. 0dB
 ...
 */
at_ble_status_t at_ble_init(uintptr_t handle);
...
/**@brief Sets TX gain, relative to maximum gain, for a given connection, @ref AT_BLE_TX_POWER_SET event is used to inform
...
/**@brief Requests the TX power of a given connection, @ref AT_BLE_TX_POWER_VALUE event is used to provide the
 * power in dB.
 *
 * @param[in] conn_handle handle of the connection
 *
 ...
 * @return @ref AT_BLE_FAILURE Generic error
 */
at_ble_status_t at_ble_tx_power_get(at_ble_handle_t conn_handle);

/**@brief Requests the maximum allowed TX gain of a given connection, @ref AT_BLE_MAX_PA_GAIN_VALUE event is used
 * to provide the PA gain in dB
 *
 * @param[in] conn_handle Handle of the connection
 *
 * @return @ref AT_BLE_SUCCESS Operation completed successfully
 ...
 * @return @ref AT_BLE_FAILURE Generic error
 */
at_ble_status_t at_ble_max_PA_gain_get(at_ble_handle_t conn_handle);

/**@brief Requests the RX power of a given connection, @ref AT_BLE_RX_POWER_VALUE event is used
 * to provide the RX power (RSSI) in dBm.
 *
 * @param[in] conn_handle Handle of the connection
 *
 * @return @ref AT_BLE_SUCCESS Operation completed successfully
