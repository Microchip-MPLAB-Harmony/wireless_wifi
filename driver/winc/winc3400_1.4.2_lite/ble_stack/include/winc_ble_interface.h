...
#define INTERFACE_SEND_NO_WAIT()\
    interface_send(interface_send_msg, (uint16_t)(__ptr - &interface_send_msg[INTERFACE_HDR_LENGTH]))

#define INTERFACE_SEND_WAIT(msg_id, src_id)\
    interface_send_wait(interface_send_msg, (uint16_t)(__ptr - &interface_send_msg[INTERFACE_HDR_LENGTH]), (uint16_t)msg_id, (uint16_t)src_id, &__ptr)
