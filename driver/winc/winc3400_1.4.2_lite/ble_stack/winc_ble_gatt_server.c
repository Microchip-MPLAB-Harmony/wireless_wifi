        ...
        at_ble_characteristic_t *characteristic)
{
    ...
    if (att_status == ATT_ERR_NO_ERROR)
    {
        ...
        temp_buff[1] = (uint8_t)characteristic->presentation_format->exponent;
        ...
        at_ble_included_service_t *included_list, uint16_t included_count, at_ble_characteristic_t *charactristic_list, uint16_t char_count, bool primary)
{
    ...
    do
    {
        ...
        /* initially, we need one attribute for the service declaration itself */
        ...
        for (i = 0; i < char_count; i++)
        {
            ...
            /* then the characteristic-containing attribute itself */
        ...
        *service_handle = start_hdl;
        ...
        for (i = 0; i < char_count; i++)
        {
            ...
            /* lets set the value of "char dec" attribute, this was deferred until we got the handle from the above step */
