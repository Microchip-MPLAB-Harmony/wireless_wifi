...
{
    SYS_PORT_PinClear(PORT_PIN_PB06);// reset pin
}
...
{
    SYS_PORT_PinSet(PORT_PIN_PB06); // reset pin
}
...
{
    SYS_PORT_PinSet(PORT_PIN_PB05); // chip enable
}
...
{
    SYS_PORT_PinClear(PORT_PIN_PB05); // chip enable
}
